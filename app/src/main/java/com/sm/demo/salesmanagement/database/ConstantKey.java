...
public class ConstantKey {
    ...
    protected final static String CREATE_SUPPLIERS_TABLE = "CREATE TABLE " + SUPPLIERS_TABLE_NAME + " (" + COLUMN_ID + " INTEGER PRIMARY KEY, " + SUPPLIERS_COLUMN1 + " TEXT, " + SUPPLIERS_COLUMN2 + " TEXT, " + SUPPLIERS_COLUMN3 + " TEXT, " + SUPPLIERS_COLUMN4 + " TEXT, " + SUPPLIERS_COLUMN5 + " TEXT, " + SUPPLIERS_COLUMN6 + " TEXT, " + SUPPLIERS_COLUMN7 + " TEXT, " + SUPPLIERS_COLUMN8 + " TEXT, " + SUPPLIERS_COLUMN9 + " TEXT, " + SUPPLIERS_COLUMN10 + " TEXT, " + SUPPLIERS_COLUMN11 + " TEXT, " + SUPPLIERS_COLUMN12 + " TEXT, " + SUPPLIERS_COLUMN13 + " TEXT ) ";
    ...
    protected final static String CREATE_PRODUCTS_TABLE = "CREATE TABLE " + PRODUCTS_TABLE_NAME + " (" + COLUMN_ID + " INTEGER PRIMARY KEY, " + PRODUCTS_COLUMN1 + " TEXT, " + PRODUCTS_COLUMN2 + " TEXT, " + PRODUCTS_COLUMN3 + " INTEGER, " + PRODUCTS_COLUMN4 + " REAL, " + PRODUCTS_COLUMN5 + " TEXT, " + PRODUCTS_COLUMN6 + " TEXT, " + PRODUCTS_COLUMN7 + " TEXT, " + PRODUCTS_COLUMN8 + " TEXT, " + PRODUCTS_COLUMN9 + " TEXT ) ";
    ...
    protected final static String CREATE_SALES_TABLE = "CREATE TABLE " + SALES_TABLE_NAME + " (" + COLUMN_ID + " INTEGER PRIMARY KEY, " + SALES_COLUMN1 + " TEXT, " + SALES_COLUMN2 + " TEXT, " + SALES_COLUMN3 + " INTEGER, " + SALES_COLUMN4 + " INTEGER, " + SALES_COLUMN5 + " TEXT, " + SALES_COLUMN6 + " TEXT, " + SALES_COLUMN7 + " TEXT, " + SALES_COLUMN8 + " REAL, " + SALES_COLUMN9 + " REAL, " + SALES_COLUMN10 + " REAL, " + SALES_COLUMN11 + " REAL, " + SALES_COLUMN12 + " REAL, " + SALES_COLUMN13 + " TEXT, " + SALES_COLUMN14 + " TEXT, " + SALES_COLUMN15 + " TEXT, " + SALES_COLUMN16 + " TEXT ) ";
